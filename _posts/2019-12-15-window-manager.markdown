...
thumbnail: /assets/kerning.jpg
---

![Current state of the GUI](/assets/kerning.jpg){:class="thumbnail" title="The background is generated by setting the ith pixel to 'i | i*512 | i % 512'" }
